...
//		String url = "http://130.162.132.21:8080/OpenApi/openapi/myaccount/transaction/history.json";
		String url = "http://130.162.132.21:8080/OpenApi/openapi/myaccount.json";
//		String url = "http://132.226.23.122/TeamTwoOpenAPI/AccountList.json";

//		String data = "{ \"acctNO\": \"100099085264\" }"; // json 형식 데이터
		String data = "{ \"bank_code\": \"1000\", \"tel\": \"01026093796\" }"; // json 형식 데이터
//		String data = "{ key:\'FR587250820200O4HL8RQNR5\', accountNumber:\'01026093796\', bankCode:\'02\' }"; // json 형식 데이터
	...
	public static void httpPostBodyConnection(String UrlData, String ParamData) {
		...
		try {
			...
			System.out.println("http 요청 주소 : " + url.toString());
